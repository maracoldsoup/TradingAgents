...
class AgentState(MessagesState):
    ...
    trader_structured: Annotated[
        dict, "TraderProposal fields as a JSON-safe dict ({} on free-text fallback)"
    ]
    ...
    pm_structured: Annotated[
        dict, "PortfolioDecision fields as a JSON-safe dict ({} on free-text fallback)"
    ]
